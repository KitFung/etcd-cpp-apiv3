...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_etcdserver_2eproto = {
  false, false, descriptor_table_protodef_etcdserver_2eproto, "etcdserver.proto", 363,
...
static bool dynamic_init_dummy_etcdserver_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_etcdserver_2eproto)), true);
namespace etcdserverpb {
...
Request::Request(const Request& from)
  ...
  if (from._internal_has_prevvalue()) {
    prevvalue_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_prevvalue(),
      GetArena());
  }
  ::memcpy(&id_, &from.id_,
