...
inline void Request::clear_prevvalue() {
  prevvalue_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
inline void Request::_internal_set_prevvalue(const std::string& value) {
  _has_bits_[0] |= 0x00000008u;
  prevvalue_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void Request::set_prevvalue(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000008u;
  prevvalue_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void Request::set_prevvalue(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000008u;
  prevvalue_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* Request::_internal_mutable_prevvalue() {
  _has_bits_[0] |= 0x00000008u;
  return prevvalue_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
